...
#Region "Funciones y Metodos"
    ...
    Public Sub CrearHTML()
        TextBox1.Text = "<HTML><HEAD></HEAD><META HTTP-EQUIV=REFRESH CONTENT=""0; URL=http://PUBLICA:88""><BODY><center>Un momento por favor...</center><center><A HREF=""http://PUBLICA:88"">Haga click aqu� si esta p�gina no cambia...</a></center></BODY></HTML>"
    ...
    Public Sub BuscarIP()
        VariableFiltrada = QuitarCaracteres(GetExternalIP, " :<>{}[]^+,;_-/*?¿!$%&/¨Ññ()='áéíóúÁÉÍÓÚ¡abcdefghijklmnñopqrstuvwxyzCIPA" + Chr(34))
...
#Region "Formulario"
    Private Sub ActualizarHTML_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ActualizarHTML.Click
        CrearHTML()
    End Sub

    Private Sub SubirFTP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SubirFTP.Click
        subirFichero()
    End Sub

    Public Sub ObtenerIP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ObtenerIP.Click
        BuscarIP()
    End Sub
#End Region
    ...
    Private Sub ConsultasToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ConsultasToolStripMenuItem.Click
        'Mail.MailAddress = "mauricio.dellanave@hotmail.com"
    End Sub
End Class
